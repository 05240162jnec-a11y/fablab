                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative">
                            <div className="w-16 h-16 rounded-full flex items-center justify-center text-white text-xl font-bold shadow-md overflow-hidden cursor-pointer"
                                ...
                                {photoPreview ? <img src={photoPreview} alt="Profile" className="w-full h-full object-cover" /> : user?.name?.charAt(0) || 'A'}
                            </div>
                        ...
                        <div className="flex-1">
                            ...
                            <span className="inline-flex mt-1 px-3 py-1 rounded-full text-xs font-medium bg-red-100 text-red-700 border border-red-200">Administrator</span>
                        </div>
                    </div>
                </div>
