    ...
    return (
        <div className="p-6">
            ...
            <header className="mb-6">
                ...
                <p className="text-sm text-gray-600">Welcome back! Here's your production overview.</p>
            </header>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
                ...
                <div className="grid md:grid-cols-3 gap-6 mt-8">
                    ...
                    <div className="bg-green-50 rounded-xl p-6 border border-green-100 hover:shadow-md transition">
                        ...
                        <h3 className="font-semibold text-green-800 mb-2">Machine Booking</h3>
                        <p className="text-sm text-green-600">Reserve lab equipment for your production tasks.</p>
                    </div>

                    {/* Inventory Card */}
                    <div className="bg-purple-50 rounded-xl p-6 border border-purple-100 hover:shadow-md transition">
                        ...
                        <h3 className="font-semibold text-purple-800 mb-2">Inventory Management</h3>
                        <p className="text-sm text-purple-600">Track materials, issue supplies, and monitor stock levels.</p>
                    </div>
                </div>
            </div>
        </div>
