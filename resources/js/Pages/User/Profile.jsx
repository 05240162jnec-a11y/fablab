...
export default function UserProfile() {
    ...
    // ✅ FIXED: Fetch current user profile - ONLY fetches data
    ...
    // ✅ FIXED: Save profile updates - handles success message and sessionStorage
    ...
    const getRoleBadgeColor = (role) => {
        const colors = {
            ...
            'production_team': 'bg-green-100 text-green-700 border-green-200',
