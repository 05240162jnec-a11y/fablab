                                ...
                                <tr>
                                    <td style="padding:40px 40px 32px;">
                                        ...
                                        <p style="margin:0 0 24px;font-size:15px;color:#374151;line-height:1.7;">
                                            ...
                                            <strong style="color:#0f172a;">{{ $booking->machine->name }}</strong>
                                            has been terminated as you did not arrive within the scheduled time window.
                                        </p>
                                        ...
                                        <p style="margin:0 0 24px;font-size:14px;color:#475569;line-height:1.7;">
                                            If you believe this termination was made in error, or if you experienced
                                            an emergency, please contact the Fab Lab administration team immediately
